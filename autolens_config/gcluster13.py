...
def generate_realistic_cluster_galaxies(
    ...
    cluster_halo = al.mp.gNFW(
        ...
        scale_radius=np.random.uniform(20.0, 40.0),
        inner_slope=1.0
    )
...
def simulate_realistic_cluster_lensing(
    ...
    grid = al.Grid2D.uniform(shape_native=(200, 200), pixel_scales=0.1)
    ...
    if plot_result:
        ...
        # Show all subplots (image, noise_map, etc.):
        imaging_plotter.subplot_dataset()

        # If you want to see the Tracer subplots (lensing planes, etc.), uncomment:
