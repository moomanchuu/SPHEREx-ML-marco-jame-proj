...
def generate_gaussian_distributed_galaxy_cluster(n, center=(0.0, 0.0), std_dev=2.0, redshift=0.5):
...
def random_position_within_circle(radius_min=1.0, radius_max=4.0):
...
position_std_dev = 2.0  # Standard deviation of positions
...
# Generate a random position for the source galaxy within a circle of radius 4.0, with a minimum radius to avoid overlap
source_position = random_position_within_circle(radius_min=1.0, radius_max=4.0)
...
grid = al.Grid2D.uniform(
    ...
    pixel_scales=0.15  # Larger pixel scale to expand the field of view
)
